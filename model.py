...
if __name__=="__main__":
    ...
    model = get_model()
    model.fit_generator(generate_batch(X_train, y_train), samples_per_epoch=24000, nb_epoch=10, validation_data=generate_batch(X_validation, y_validation), nb_val_samples=1024)#, callbacks=[early_stop])
