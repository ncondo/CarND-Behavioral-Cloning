...
def get_model():
    ...
    model = Sequential([
        ...
        Convolution2D(24, 5, 5, border_mode='valid', activation='relu', subsample=(2, 2), W_regularizer=l2(0.01), init='he_normal'),
        # Convolutional layer 2 36@14x47 | 5x5 kernel | 2x2 stride | relu activation
        Convolution2D(36, 5, 5, border_mode='valid', activation='relu', subsample=(2, 2), W_regularizer=l2(0.01), init='he_normal'),
        # Convolutional layer 3 48@5x22  | 5x5 kernel | 2x2 stride | relu activation
        Convolution2D(48, 5, 5, border_mode='valid', activation='relu', subsample=(2, 2), W_regularizer=l2(0.01), init='he_normal'),
        # Convolutional layer 4 64@3x20  | 3x3 kernel | 1x1 stride | relu activation
        Convolution2D(64, 3, 3, border_mode='valid', activation='relu', subsample=(1, 1), W_regularizer=l2(0.01), init='he_normal'),
        ...
        Dense(100, activation='relu', W_regularizer=l2(0.01), init='he_normal'),
        # Dropout with keep probability of .5
        Dropout(.5),
        # Fully-connected layer 2 | 50 neurons
        Dense(50, activation='relu', W_regularizer=l2(0.01), init='he_normal'),
        # Dropout with keep probability of .5
        Dropout(.5),
